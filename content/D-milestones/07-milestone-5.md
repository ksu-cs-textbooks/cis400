...
![Selecting the Project Properties in Visual Studio]({{<static "images/d.7.8.png">}})
...
![Updating Default Namespace and Assembly Names]({{<static "images/d.7.9.png">}})
...
![Example POS Main Screen]({{<static "images/d.7.6.png">}})
...
![Example POS Customization Screen]({{<static "images/d.7.7.png">}})
